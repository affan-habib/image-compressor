          ...
          <div className="mt-8">
            {hasCompressedImages && (
              <button
                ...
                className="mb-4 flex items-center justify-center w-full px-4 py-2 text-sm font-medium text-white bg-blue-500 rounded-md hover:bg-blue-600 transition-colors"
              >
